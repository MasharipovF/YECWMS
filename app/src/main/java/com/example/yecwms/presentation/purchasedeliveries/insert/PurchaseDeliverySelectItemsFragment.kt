...
import com.example.yecwms.databinding.FragmentPurchasedeliverySelectBinding
...
class PurchaseDeliverySelectItemsFragment : Fragment() {
    ...
    private lateinit var binding: FragmentPurchasedeliverySelectBinding
    private lateinit var itemsAdapter: ItemsListAdapter
    private lateinit var mViewModel: PurchaseDeliveryInsertViewModel


    companion object {
        fun newInstance() = PurchaseDeliverySelectItemsFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_purchasedelivery_select, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentPurchasedeliverySelectBinding.bind(view)
        mViewModel =
        ...
        mViewModel.itemsFilterString.observe(viewLifecycleOwner) {
            if (it != null) {
                if ((activity as PurchaseDeliveryInsertActivity).canLoadItems()) {
        ...
        mViewModel.currentChosenBp.observe(viewLifecycleOwner) {
            if (it != null) {
                ...
                if (mViewModel.isCopiedFrom.value != true) {
                    (activity as PurchaseDeliveryInsertActivity).setCurrency(it.Currency.toString())
                }
    ...
    private fun disableBodySection(disable: Boolean) {
        if (disable) {
            ...
            binding.tvManager.isEnabled = false
            ...
            binding.tvManager.isEnabled = true
